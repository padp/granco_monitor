...
def get_part_multiple(d):
    for shift in d:
        ...
        if a_last_cut_time != None:
            break_minutes = 10 if a_last_cut_time > i_first_break_time else 40
            ...
            d[shift]['shift_summary']['net_shift_efficiency'] = sum(theoretical_elapsed_lists) / sum(actual_elapsed_lists)
