...
Ported from Fetch Log Data/collector/login.py (a working, already-proven
integration) rather than rebuilt from the raw browser OIDC flow.
"""
import os
import re
...
CLIENT_ID = "B1371A12-25E2-4422-94ED-8E2983F81C66"  # from the authorize URL
...
def extract_asid(resp: requests.Response):
    """
