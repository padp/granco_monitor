...
def ensure_indexes():
    ...
    db.production_events.create_index("ts")
    ...
    db.part_sessions.create_index("session_key", unique=True)
    ...
    db.alert_rules.create_index("created_at")
    db.alert_rules.create_index("active")
